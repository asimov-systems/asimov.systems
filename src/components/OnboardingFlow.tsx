...
export function OnboardingFlow({ user: _user }: OnboardingFlowProps) {
  ...
  // Reserved for future use - currently redirects to dashboard for payment
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const _handleReserveUsername = async () => {
      ...
      <div className="mx-auto max-w-2xl">
        {step === 'welcome' && (
          <Card className="border-slate-700 bg-slate-800/50 backdrop-blur-lg">
            <CardHeader>
              <CardTitle className="text-3xl text-white">Welcome to ASIMOV! 👋</CardTitle>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Your data stays with you, always</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-orange-500" />
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Upgrade to VIP for premium features</p>
                  </div>
                </div>
              </div>
        ...
        {step === 'username' && (
          <Card className="border-slate-700 bg-slate-800/50 backdrop-blur-lg">
            <CardHeader>
              <CardTitle className="text-2xl text-white">Choose Your Username</CardTitle>
              <CardDescription className="text-slate-300">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-t border-slate-700 pt-6">
                <p className="mb-4 text-sm text-slate-400">
                  <strong className="text-white">Become a VIP Member</strong> - $100 one-time
                  payment
                </p>
        ...
        {step === 'complete' && (
          <Card className="border-slate-700 bg-slate-800/50 backdrop-blur-lg">
            <CardHeader>
              ...
              <CardTitle className="text-center text-2xl text-white">All Set! 🎉</CardTitle>
            ...
            <CardContent className="space-y-6">
              <div className="rounded-lg bg-slate-900/50 p-4 text-center">
                ...
                <p className="mt-1 text-xl font-semibold text-orange-500">{username}.asimov.id</p>
              </div>
              <Button
