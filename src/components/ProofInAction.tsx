...
const topItems = [
  ...
  },
  {
    ...
    description: "such as email, Telegram, Slack, CRM’s, note takers, calendars -  and even paywalled external sources (e.g. Crunchbase) - for unified context.",
    images: [
      {
...
const bottomItems = [
  ...
  },
  {
    ...
    description:
      "no setup headaches, just sync, connect, and go.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "See exactly where facts came from, in your chosen AI’s interface.",
    images: [
      {
  ...
  return (
    <section className="py-32">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <p className="mt-8 md:mt-12 lg:mt-20 text-center text-lg text-muted-foreground">
          Our first flagship product, available for waitlist now.
        </p>

        <h2 className="mt-8 md:mt-12 lg:mt-20 text-center text-xl font-semibold tracking-tight text-balance sm:text-2xl md:text-3xl lg:text-4xl">
