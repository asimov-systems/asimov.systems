    ...
    <>
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              Typical cheque size per investment: <span className="text-red-500">*</span>
            </FormLabel>
      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            <FormLabel>
              Which rounds are you interested in? <span className="text-red-500">*</span>
            </FormLabel>
      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            <FormLabel>
              Deployment horizon: <span className="text-red-500">*</span>
            </FormLabel>
