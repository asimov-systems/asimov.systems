...
const Highlight = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => {
  return (
    <span className={`text-black dark:text-white ${className}`}>
      {children}
    </span>
  );
};
    ...
    <>
      <section className="py-32">
        <div className="container mx-auto flex flex-col items-center justify-center gap-4 overflow-hidden px-4 lg:px-6">
          ...
          <h1 className="font-calSans max-w-3xl text-center text-3xl md:text-4xl">
            Our mission is to take our customers from <br /><i>cognitive overload to cognitive clarity.</i>
          </h1>
      ...
      <section className="overflow-hidden py-32">
        <div className="container w-full mx-auto px-4 lg:px-6">
          ...
          <Highlight className="px-1">tired</Highlight>{" "}
          of the{" "}
          <Highlight className="px-1">broken promises of AI</Highlight>,{" "}
          tired of the {" "}
          <Highlight className="px-1">lack of trust</Highlight>,{" "}
          and the data breaches, then you will be glad to know that {" "}
          <Highlight className="px-1">
            ASIMOV Systems
          </Highlight>{" "}
          has {" "}
          <Highlight className="px-1">redefined intelligence for the digital age.</Highlight>
          <br />
          We build breakthrough AI and Web3 solutions that cut through the noise, so human insight, context, and {" "}
          <Highlight className="px-1">confidence are never lost.</Highlight>
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center">
            <h2 className="mt-12 text-2xl font-bold lg:text-3xl">
              ...
              <br />privacy, reliability, and truth.
            </h2>
          ...
          <p className="mt-12 text-muted-foreground text-xl">
            For individuals, ASIMOV puts the power of a personal intelligence agency right in their pocket.
          </p>

          <p className="mt-12 text-muted-foreground text-xl">
            For enterprise, we deploy proven companion tools that sharpen employee insight, supercharge productivity, and give leaders the confidence to act on trusted knowledge with cognitive clarity.
          </p>
